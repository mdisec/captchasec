...
class Report():
    """
    İstifadəçi seçimi ilə hesabat yaratmaq üçün sinif
    """
    ...
    def json_report(self):
        """
        Nəticələri fayla yazmaq üçün json kitabxanasını daxil edin.
        :return:
        """
        import json
        print "CSV cavabı hazırlanır."
    ...
    def csv_report(self):
        """
        Nəticələri csv faylına yazmaq üçün csv kitabxanasını daxil edin.
        :return:
        """
        import csv
        print "CSV cavabı hazırlanır."
        ...
        print "Məlumatlar burada saxlandı {}".format(f_name)
    ...
    def html_report(self):
        ...
        <div class="container">
            ...
            <footer class="footer">
                <p>&copy; captchasec tərəfindən hazırlanıb v0.0.1</p>
            </footer>
        </div>
        <!-- /container -->
        </body>
